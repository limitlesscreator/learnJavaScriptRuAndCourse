...
man2FullCopy.friends.push('John')
...
man4FullCopy.mother.work.position = "waiter"
console.log(man4)
...
man5FullCopy.mother.name = "Lora"
man5FullCopy.mother.work.position = "Web Developer"
man5FullCopy.mother.parents[0].age = 81
console.log(man5)
...
man6FullCopy.mother.parents[0].favoriteDish.title = "blueberry"
...
let man7FullCopy = {
    ...man7,
    mother: {
        ...man7.mother, work: {...man7.mother.work},
        parents: [...man7.mother.parents.map(el => {
            return {
                ...el, favoriteDish: {
                    ...el.favoriteDish, ingredients: [...el.favoriteDish.ingredients.map(elIngredients => {
...
console.clear()
man7FullCopy.mother.parents[1].favoriteDish.ingredients[0].title = "pizza"
console.log(man7FullCopy.mother.parents[1].favoriteDish.ingredients[0].title)
console.log(man7.mother.parents[1].favoriteDish.ingredients[0].title)
